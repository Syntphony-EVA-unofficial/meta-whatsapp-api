...
def verify(request: Request):
    ...
    verifyToken = session.check_record(botid, phoneid)
    
    if (verifyToken):
        logging.info("Bot and numberid are present in database")

    else:
        logging.info("Bot and numberid are not present in database")
